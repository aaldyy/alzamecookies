...
import ContactBackground from '../../assets/contact/sss.jpg';
...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    emailjs.send("service_evfzn0s", "template_inov89p", template_params, "HFlkfalVaTqSsg99g").then(
      function (response) {
    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <p className="font12">
            Siap melayani kalian dalam keadaan apapun !!!
          </p>
